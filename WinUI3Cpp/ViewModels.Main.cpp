...
namespace winrt::WinUI3Cpp::ViewModels::implementation
{
    Main::Main()
    {
    ...
    winrt::Windows::Foundation::IAsyncAction Main::StartProcess()
    {
        ...
        m_propertyChanged(*this, Microsoft::UI::Xaml::Data::PropertyChangedEventArgs{ L"thing" });
    }

    winrt::event_token Main::PropertyChanged(winrt::Microsoft::UI::Xaml::Data::PropertyChangedEventHandler const& handler)
    {
